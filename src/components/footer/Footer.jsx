        ...
        <div className="w-full max-w-3xl mt-6 border-gray-300 dark:border-gray-600" />
            <div className="flex flex-col items-center sm:flex-row sm:justify-between">
                ...
                <div className="flex -mx-2">
                    <a href="https://www.facebook.com/share/1F3KWRqu8b/ " target="_blank" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Facebook">
                      ...
                      <a href="https://github.com/" target="_blank" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Github">
